...
from logging_functions import EraLogger, SaveData, calculate_avg_lifetime
...
model_dict = {}
with open("NewSpawn__agents_model_dict_499999.pickle", 'rb') as file:
...
avail_index = []
# The main loop
for step in range(499999, steps):
    if env.num_agents ==0 :
        print('extinction')
        for i in range(player_N):
