...
from real_time_evolution import simple_mutate
torch.set_num_threads(1)


### Save destination.
EXP_NAME = 'RemadeNewSpawns'
...
def RunEra(startStep, env, model_dict, eraLogger):
    ...
    while True:
        ...
        deadAgents = deque(sorted(deadAgents)) # Original newspawns prioritized low agent ids
        while len(deadAgents) > 0:
            ...
            if len(birthReadyAgents) != 0:
                ...
                model_dict[newAgent] =  copy.deepcopy(model_dict[parent])
